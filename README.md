...
2. The app auto-creates your player row (device-id based), and pushes XP, streaks, coins, nickname, and completed lessons after each save. A live weekly leaderboard ranks players by XP earned this week.
